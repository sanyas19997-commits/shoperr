    <header class="header sticky-bar header-style-1">
      ...
      <div class="container">
        <div class="main-header">
          <div class="header-logo"><a class="d-flex" href="{{ route('home') }}"><img alt="Billaro Store" src="{{ asset('kidify/assets/imgs/template/logo.svg') }}"></a></div>
          <div class="header-menu">
            <div class="header-nav">
              <nav class="nav-main-menu d-none d-xl-block">
                <ul class="main-menu">
                  <li class="has-mega-menu"><a class="active" href="{{ route('home') }}">Главная</a>
                    <div class="sub-menu">
                      <div class="menu-inner">
                        <div class="col-menu">
                          <h6 class="font-lg-bold mb-10">Главные страницы</h6><a href="{{ route('home') }}">Главная 1</a><a href="{{ route('home') }}">Главная 2</a><a href="{{ route('home') }}">Главная 3</a><a href="{{ route('home') }}">Главная 4</a><a href="{{ route('home') }}">Главная 5</a>
                        </div>
                        <div class="col-menu">
                          <h6 class="font-lg-bold mb-10">Игрушки</h6><a href="{{ route('catalog.index') }}">Конструкторы</a><a href="{{ route('catalog.index') }}">Куклы и мягкие игрушки</a><a href="{{ route('catalog.index') }}">Фигурки</a><a href="{{ route('catalog.index') }}">Творчество</a><a href="{{ route('catalog.index') }}">Развивающие пазлы</a><a href="{{ route('catalog.index') }}">Уличные игрушки</a><a href="{{ route('catalog.index') }}">Настольные игры</a><a href="{{ route('catalog.index') }}">Музыкальные игрушки</a>
                        </div>
                        <div class="col-menu">
                          <h6 class="font-lg-bold mb-10">Аксессуары</h6><a href="{{ route('catalog.index') }}">Украшения и часы</a><a href="{{ route('catalog.index') }}">Сумки</a><a href="{{ route('catalog.index') }}">Шапки и кепки</a><a href="{{ route('catalog.index') }}">Шарфы и палантины</a><a href="{{ route('catalog.index') }}">Ремни</a><a href="{{ route('catalog.index') }}">Очки</a><a href="#">Перчатки</a><a href="{{ route('catalog.index') }}">Аксессуары для волос</a>
                        </div>
                        <div class="col-menu-2"><img src="{{ asset('kidify/assets/imgs/template/megamenu.png') }}" alt="Billaro Store"></div>
                      </div>
                    </div>
                  </li>
                  <li><a href="{{ route('about') }}">О магазине</a></li>
                  <li class="has-mega-menu"><a href="{{ route('catalog.index') }}">Каталог</a>
                    <div class="sub-menu">
                      <div class="menu-inner">
                        <div class="col-menu">
                          <h6 class="font-lg-bold mb-10">Макеты магазина</h6><a href="{{ route('catalog.index') }}">Каталог 1</a><a href="{{ route('catalog.index') }}">Каталог 2</a><a href="{{ route('catalog.index') }}">Каталог 3</a><a href="{{ route('catalog.index') }}">Карточка товара 1</a><a href="{{ route('catalog.index') }}">Карточка товара 2</a><a href="{{ route('catalog.index') }}">Карточка товара 3</a><a href="{{ route('cart.index') }}">Корзина</a><a href="{{ route('checkout.index') }}">Оформление</a><a href="{{ route('cart.index') }}">Сравнение</a>
                        </div>
                        <div class="col-menu">
                          <h6 class="font-lg-bold mb-10">Одежда</h6><a href="{{ route('catalog.index') }}">Женское</a><a href="{{ route('catalog.index') }}">Для мальчиков</a><a href="{{ route('catalog.index') }}">Уход за малышом</a><a href="{{ route('catalog.index') }}">Безопасность</a><a href="{{ route('catalog.index') }}">Спорт и активность</a><a href="{{ route('catalog.index') }}">Обувь для малышей</a><a href="{{ route('catalog.index') }}">Детская обувь</a><a href="{{ route('catalog.index') }}">Семейные комплекты</a>
                        </div>
                        <div class="col-menu">
                          <h6 class="font-lg-bold mb-10">Аксессуары</h6><a href="{{ route('catalog.index') }}">Украшения и часы</a><a href="{{ route('catalog.index') }}">Сумки</a><a href="{{ route('catalog.index') }}">Шапки и кепки</a><a href="{{ route('catalog.index') }}">Шарфы и палантины</a><a href="{{ route('catalog.index') }}">Ремни</a><a href="{{ route('catalog.index') }}">Очки</a><a href="{{ route('catalog.index') }}">Перчатки</a><a href="{{ route('catalog.index') }}">Аксессуары для волос</a>
                        </div>
                        <div class="col-menu-2"><img src="{{ asset('kidify/assets/imgs/template/megamenu.png') }}" alt="Billaro Store"></div>
                      </div>
                    </div>
          ...
          <div class="header-account"><a class="account-icon search" href="#">
              ...
              </svg></a><a class="account-icon wishlist" href="#"><span class="number-tag" id="wishlist-counter">0</span>
              <svg class="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewbox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
              ...
              </svg></a><a class="account-icon cart" href="{{ route('cart.index') }}"><span class="number-tag" id="cart-counter">{{ $cartCount ?? 0 }}</span>
